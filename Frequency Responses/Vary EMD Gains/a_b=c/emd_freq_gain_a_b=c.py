...
def freq_response_emd(gains_left, gain_center, gain_right, freqs, num_cycles, t4=True):
    ...
    for g in range(num_gains):
        ...
        if t4:
            model, net = gen_test_emd((7,7), k_mi1=gain_center, k_mi9=gains_left[g], k_ct1on=gain_right,
                                      output_t4a=True, output_t4b=True)
        else:
            model, net = gen_test_emd((7, 7), k_tm1=gain_center, k_tm9=gains_left[g], k_ct1off=gain_right,
