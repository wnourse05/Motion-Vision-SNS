...
def freq_response_emd(gains_left, gains_center, gains_right, freqs, num_cycles, t4=True):
    ...
    for g in range(num_gains):
        ...
        if t4:
            model, net = gen_motion_vision((7, 7), k_mi1=gains_center[g], k_mi9=gains_left[g], k_ct1on=gains_right[g], output_t4a=True, output_t4b=True)
        else:
            model, net = gen_motion_vision((7, 7), k_tm1=gains_center[g], k_tm9=gains_left[g], k_ct1off=gains_right[g],
