...
def freq_response_emd(gain_left, gains_center, gain_right, freqs, num_cycles, t4=True):
    ...
    for g in range(num_gains):
        ...
        if t4:
            model, net = gen_motion_vision((7, 7), k_mi1=gains_center[g], k_mi9=gain_left, k_ct1on=gain_right,
                                           output_t4a=True, output_t4b=True)
        else:
            model, net = gen_motion_vision((7, 7), k_tm1=gains_center[g], k_tm9=gain_left, k_ct1off=gain_right,
