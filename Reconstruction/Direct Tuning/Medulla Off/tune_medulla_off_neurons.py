...
try:
    tune_neuron(medulla_off, 0, min_angle=-(res*2), max_angle=res*2, res=res)
except:
    print('Tm1 Failed. Moving on')
try:
    tune_neuron(medulla_off, 1, min_angle=-(res*2), max_angle=res*2, res=res)
except:
    print('Tm2 Failed. Moving On')
try:
    tune_neuron(medulla_off, 2, min_angle=-(res*2), max_angle=res*2, res=res)
except:
    print('Tm4 Failed. Moving On')
try:
    tune_neuron(medulla_off, 3, min_angle=-(res*2), max_angle=res*2, res=res)
except:
    print('Tm9 Failed. Moving On')
